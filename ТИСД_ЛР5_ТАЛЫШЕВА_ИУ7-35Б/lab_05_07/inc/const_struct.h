...
#define ERROR_USER -2
// сколько проходит очередь одна заявка
#define MAX_COUNT_WORK1 5
// длина статической очереди
#define MAX_COUNT_APP 10000
// через сколько заявок выводить частичный доклад
#define REPORT_COUNT_APP 100
// сколько нужно чтобы вышло из системы заявок до завершения симуляции
