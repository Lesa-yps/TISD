...
void build_res_find(void)
{
    ...
    ft_u8write_ln(table, "Отсортированный (время)", time_add_file_5_side_char, time_add_tree_5_side_char, perc_double(time_add_file_5_side, time_add_tree_5_side, buffer));
    ft_u8write_ln(table, "Сбалансированный (время)", time_add_file_5_balance_char, time_add_tree_5_balance_char, perc_double(time_add_file_5_balance, time_add_tree_5_balance, buffer));
    ft_u8write_ln(table, "Рандомный (время)", time_add_file_5_random_char, time_add_tree_5_random_char, perc_double(time_add_file_5_random, time_add_tree_5_random, buffer));
    ft_u8write_ln(table, "Память", mem_file_5_char, mem_tree_5_char, perc_double(mem_file_5, mem_tree_5, buffer));
